"""
Plot regression patterns for amips in the extratropics indices
...
directoryfigure = '/home/Zachary.Labe/Research/Attribution_SpringNA/Figures/v2/AMIPs/RegressionPatternsAMIPS/' 
...
indicesdir = ['ABI','NPO','AL','PNA','NAO','NPI','PCHT2M','PCHZ30','PCHZ100','PCHZ1000','SHI','UBI']
indices = ['ABI','NPO','AL','PNAmodified','NAOmodified','NPI','PCHT2M','PCHZ30','PCHZ100','PCHZ1000','SHI','UBI']
indicesvari = ['Z500','SLP','SLP','Z500','SLP','SLP','T2M','Z30','Z100','Z1000','SLP','Z500']
...
for i in range(len(indices)):
    for mm in range(len(models)):
        ...
        amip = np.load(directoryoutput + 'ClimateIndices_AMIPSPEAR_%s_1979-2020.npz' % mon_index)
        ...
        plt.savefig(directoryfigure + 'RegressionAMIP_pattern_%s-%s_%s-%s_%s.png' % (variq,mon_t2m,indices[i],mon_index,models[mm]),dpi=300)
        
        ### Save file
        np.savez(directorydataoutput + 'RegressionAMIP_pattern_%s-%s_%s-%s_%s.png' % (variq,mon_t2m,indices[i],mon_index,models[mm]),

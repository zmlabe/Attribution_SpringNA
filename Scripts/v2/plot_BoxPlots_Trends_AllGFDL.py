"""
Plot box plots of trends over different time periods compared to all GFDL models
...
datum = [decgfdlem,decgfdlcm,decflor,decspear]
...
plt.setp(axb,yticks=[y+1 for y in range(len(datum))],
                     yticklabels=['GFDL-ESM2M (30)','GFDL-CM3 (20)','FLOR (30)','SPEAR_MED (30)'])
...
plt.text(decobs,4.6,r'ERA5',size=11,color='k',ha='center',va='center')

plt.tight_layout()
plt.savefig(directoryfigure + 'TrendViolins_AllGFDL_%s_%s-%s.png' % (sliceperiod,yrmin,yrmax),dpi=300)

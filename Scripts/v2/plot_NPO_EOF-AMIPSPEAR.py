...
directoryfigure = '/home/Zachary.Labe/Research/Attribution_SpringNA/Figures/v2/AMIPs/NPO/' 
...
plt.savefig(directoryfigure + 'EOF2_NPO_%s_AllTimePeriods_AMIPSPEAR.png' % sliceperiod,dpi=300)
...
plt.title(r'\textbf{Shift in the NPO centers of action - %s -- AMIP-SPEAR}' % sliceperiod,fontsize=12,color='k')
plt.savefig(directoryfigure + 'EOF2_NPOshift_AMIP_%s.png' % sliceperiod,dpi=300)

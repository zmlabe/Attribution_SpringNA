"""
Plot regression patterns for SPEAR in the extratropics indices
...
directoryfigure = '/home/Zachary.Labe/Research/Attribution_SpringNA/Figures/v2/SPEAR/RegressionPatternsSPEAR/' 
directorydata = '/home/Zachary.Labe/Research/Attribution_SpringNA/Data/v2/SPEAR/' 
directorydata2 = '/home/Zachary.Labe/Research/Attribution_SpringNA/Data/v2/SPEAR/' 
directorydataoutput = '/home/Zachary.Labe/Research/Attribution_SpringNA/Data/v2/SPEAR/'
...
for i in range(len(indices)):
    for mm in range(len(models)):
        ### Read in SPEAR indices
        amip = np.load(directorydata + 'ClimateIndices_coupledSPEAR_%s_1979-2020.npz' % mon_index)
        amipi = amip['spear'][i,:,:]
        ...
        plt.savefig(directoryfigure + 'RegressionSPEAR_pattern_%s-%s_%s-%s_%s.png' % (variq,mon_t2m,indices[i],mon_index,models[mm]),dpi=300)
        
        ### Save file
        np.savez(directorydataoutput + 'RegressionSPEAR_pattern_%s-%s_%s-%s_%s.png' % (variq,mon_t2m,indices[i],mon_index,models[mm]),

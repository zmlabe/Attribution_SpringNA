...
plt.plot(years,obsz,linestyle='--',dashes=(1,0.2),color='w',linewidth=2,clip_on=False,label=r'\textbf{ERA5-T2M}')
plt.plot(years,smoothed[:,1],linestyle='-',linewidth=5,color='darkgrey',clip_on=False,label=r'\textbf{Smoothed NPO* Index}')
...
plt.ylabel(r'\textbf{Standardized Index}',fontsize=8,color='darkgrey')

plt.tight_layout()
plt.savefig(directoryfigure + 'PRESENT_NPOcustomZ_Indices-Obs_%s_detrended.png' % monq,dpi=600)

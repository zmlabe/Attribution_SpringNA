...
np.savez(directoryoutput + 'AMIP_onlySPEAR_AllData_%s_%s.npz' % (slicemonth,variq),amip=amip,
        lat=lat1all,lon=lon1all)
np.savez(directoryoutput + 'AMIP_onlySPEAR_Trends_%s_%s.npz' % (slicemonth,variq),trend=trendsall,

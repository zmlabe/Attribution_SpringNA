...
PNAd = np.genfromtxt(directorydata + 'PNA/PNAmodified_%s_%s_%s-%s.txt' % ('Z500',monq,
                                                                yearmin,yearmax),
                                                                unpack=True)
years_PNA = PNAd[0,:]
PNA = sts.zscore(PNAd[1,:])
...
plt.savefig(directoryfigure + 'PNA_Indices-Obs_%s_detrended' % monq,dpi=300)

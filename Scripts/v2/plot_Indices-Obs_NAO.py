...
NAOd = np.genfromtxt(directorydata + 'NAO/NAOmodified_%s_%s_%s-%s_detrended.txt' % ('SLP',monq,
                                                                yearmin,yearmax),
                                                                unpack=True)
years_NAO = NAOd[0,:]
...
rects = plt.bar(years,NAO,align='center',zorder=2,color='crimson',label=r'NAO',clip_on=False)
...
plt.savefig(directoryfigure + 'NAO_Indices-Obs_%s_detrended' % monq,dpi=300)

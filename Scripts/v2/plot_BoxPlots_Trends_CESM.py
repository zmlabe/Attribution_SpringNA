"""
Plot box plots of trends over different time periods compared to CESM
...
datum = [declens2,declens1,decspear]
...
plt.setp(axb,yticks=[y+1 for y in range(len(datum))],
                     yticklabels=['CESM2-LE (100)','CESM1-LE (40)','SPEAR_MED (30)'])
...
plt.text(decobs,3.6,r'ERA5',size=11,color='k',ha='center',va='center')

plt.tight_layout()
plt.savefig(directoryfigure + 'TrendViolins_CESM_%s_%s-%s.png' % (sliceperiod,yrmin,yrmax),dpi=300)

...
directoryfigure = '/home/Zachary.Labe/Research/Attribution_SpringNA/Figures/v2/AMIPs/TrendsAMIPS/' 
...
plt.savefig(directoryfigure + 'TrendsMap_%s_AMIPsCoupledDifference_%s_%s_%s-%s.png'% (slicemonth,variq,trendper,yearmin,yearmax),dpi=300)

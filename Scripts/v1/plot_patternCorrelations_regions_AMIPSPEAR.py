...
directoryfigure = '/home/Zachary.Labe/Research/Attribution_SpringNA/Figures/AMIPS/PatternCorrelations/' 
...
corr = np.load(directorycorr + 'PatternCorrelations_Regional_%s_%s_AMIPSPEAR.npz' % (variq,slicemonth),
                allow_pickle=True)
echam = corr['echam']
cam = corr['cam']
spear = corr['spear']
...
plt.savefig(directoryfigure + 'patternCorrelations_regions_AMIPSPEAR_%s_%s_%s.png' % (variq,slicemonth,trendper),dpi=300)

...
directoryfigure = '/home/Zachary.Labe/Research/Attribution_SpringNA/Figures/AMIPS/' 
directorydata = '/work/Zachary.Labe/Data/' 
directorydata2 = '/home/Zachary.Labe/Research/Attribution_SpringNA/Data/Teleconnections/'
...
for iii in range(len(indices)):
    ...
    ### Read in AMIP data
    amip = np.load(directorydata2 + 'ClimateIndices-Tropical_AMIPSPEAR_%s_1979-2019.npz' % mon_index)
    ...
    amiptas = np.load(directorydata2 + 'ClimateIndices-T2M_BoxNA_AMIPSPEAR_%s_1979-2019.npz' % mon_t2m)
...
for iii in range(len(indices)):
    ### Read in AMIP data
    amip = np.load(directorydata2 + 'ClimateIndices-Tropical_AMIPSPEAR-1880rf_%s_1979-2019.npz' % mon_index)
    indices = amip['indices']
    indicesvari = amip['indicesvari']
    yearsamip = amip['years']
    ...
    ### Read in AMIP T2M data
    amiptas = np.load(directorydata2 + 'ClimateIndices-T2M_BoxNA_AMIPSPEAR-1880rf_%s_1979-2019.npz' % mon_t2m)
    indicestas = amiptas['indices']
    indicesvaritas = amiptas['indicesvari']
    yearsamiptas = amiptas['years']

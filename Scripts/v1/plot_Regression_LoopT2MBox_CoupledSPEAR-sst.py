"""
Plot regression patterns for SPEAR-MED over 1979 to 2019 for T2M_BoxNA (sst maps)
    ...
    for moo in range(len(monthsall)):
        ...
        for iii in range(len(variregress)):
            ...
            for mm in range(len(models)):
                ...
                plt.savefig(directoryfigure + 'RegressionCoupledSPEAR_T2M_BoxNApattern_%s-%s_%s-%s_%s_globalsMaps.png' % (variq,mon_t2m,'T2M_BoxNA',mon_index,models[mm]),dpi=300)

...
PNAd = np.genfromtxt(directorydata2 + 'PNA/PNAmodified_%s_%s_%s-%s_detrended.txt' % ('Z500',monq,yearmin,yearmax),unpack=True)
years_PNA = PNAd[0,:]
...
plt.savefig(directoryfigure + 'RegressionMap-ModifiedIndexPNA_%s-%s_PNAi-%s_T2M-%s.png' % (yearmin,yearmax,monq,sliceperiod),dpi=300)

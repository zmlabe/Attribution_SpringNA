"""
Plot regression patterns for SPEAR-MED-NOAER over 1979 to 2019 for tropics
...
directoryfigure = '/home/Zachary.Labe/Research/Attribution_SpringNA/Figures/CoupledSPEAR/RegressionPlots_Tropics-NOAER/' 
directorydata = '/home/Zachary.Labe/Research/Attribution_SpringNA/Data/coupledSPEAR-NOAER/' 
directoryoutput = '/home/Zachary.Labe/Research/Attribution_SpringNA/Data/RegressionPatternsCoupledSPEAR-NOAER/'
...
for i in range(len(indices)):
    for mm in range(len(models)):
        ...
        amip = np.load(directorydata + 'ClimateIndices-Tropical_coupledSPEAR-NOAER_%s_1979-2019.npz' % mon_index)
        amipi = amip['spear'][i,:,:]
        ...
        plt.savefig(directoryfigure + 'RegressionCoupledSPEAR-NOAER_Tropics_pattern_%s-%s_%s-%s_%s.png' % (variq,mon_t2m,indices[i],mon_index,models[mm]),dpi=300)
        
        ### Save file
        np.savez(directoryoutput + 'RegressionCoupledSPEAR-NOAER_Tropics_pattern_%s-%s_%s-%s_%s.npz' % (variq,mon_t2m,indices[i],mon_index,models[mm]),

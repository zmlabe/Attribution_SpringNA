...
for yr in range(len(slicemonthall)):
    ...
    plt.tight_layout()
    if detrend == False:
        plt.savefig(directoryfigure + 'ACC_%s_Hindcast-65lev_init-%s_%s_%s-%s.png'% (slicemonth,monthhind,variq,yearmin,yearmax),dpi=300)
    else: 
        plt.savefig(directoryfigure + 'ACC_%s_Hindcast-65lev_init-%s_%s_%s-%s_detrend.png'% (slicemonth,monthhind,variq,yearmin,yearmax),dpi=300)

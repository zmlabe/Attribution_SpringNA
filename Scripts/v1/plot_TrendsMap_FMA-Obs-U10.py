"""
Plot trends in FMA from 1979 to 2019 for U10
...
### Read data
data = Dataset(directorydata + 'U10_1979-2021.nc')
lat1 = data.variables['latitude'][:]
lon1 = data.variables['longitude'][:]
snd = data.variables['U10'][:].reshape(years.shape[0],12,lat1.shape[0],lon1.shape[0])
data.close()
...
label = r'\textbf{U10 Trend [m/s/decade]}'

ax = plt.subplot(111)

var = trend

m = Basemap(projection='ortho',lon_0=270,lat_0=90,resolution='l',area_thresh=10000)

...
plt.title(r'\textbf{%s-%s of NINO34i(%s)-T2M(%s)}' % (yearmin,yearmax,monq,sliceperiod),fontsize=15,color='k')
...
plt.savefig(directoryfigure + 'RegressionMap_%s-%s_NINO34i-%s_T2M-%s.png' % (yearmin,yearmax,monq,sliceperiod),dpi=300)

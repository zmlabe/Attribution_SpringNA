...
label = r'\textbf{SST Trend [$^{\circ}$/decade]}'

ax = plt.subplot(111)

var = trend

m = Basemap(projection='ortho',lon_0=235,lat_0=40,resolution='l',area_thresh=10000)
...
m.drawstates(color='dimgrey',linewidth=0.2)
m.drawcountries(color='dimgrey',linewidth=0.2)
...
plt.savefig(directoryfigure + 'TrendsMap_%s_%s-%s_SST.png' % (sliceperiod,yearmin,yearmax),dpi=300)

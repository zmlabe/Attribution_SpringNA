"""
Calculate teleconnections for SPEAR-MED-NOAER and save raw anomalies
...
for mn in range(len(monthsall)):
    ...
    ###############################################################################
    ### Save output 
    np.savez(directorydata + 'ClimateIndices_coupledSPEAR-NOAER-T2M_BoxNA_%s_1979-2019_raw.npz' % monq,

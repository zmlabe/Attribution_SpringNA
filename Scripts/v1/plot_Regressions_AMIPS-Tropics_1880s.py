"""
Plot regression patterns for amips in the tropics indices
...
for i in range(len(indices)):
    for mm in range(len(models)):
        ...
        amip = np.load(directoryoutput + 'ClimateIndices-Tropical_AMIPSPEAR-1880rf_%s_1979-2019.npz' % mon_index)

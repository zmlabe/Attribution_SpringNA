"""
Plot trends in FMA from 1979 to 2019 for U
...
### Read data
data = Dataset(directorydata + 'U_1979-2021.nc')
geop = data.variables['U'][:]
...
climo = np.nanmean(caps,axis=0)
climowinter = np.append(climo[9:,:],climo[:5,:],axis=0)
...
limit = np.arange(-3,3.05,0.05)
barlim = np.arange(-3,4,1)
cmap = cmocean.cm.balance
label = r'\textbf{U60 [m/s]}'
...
plt.savefig(directoryfigure + 'Obs_Trends-U10_Oct-Apr_1979-2019.png',dpi=300)

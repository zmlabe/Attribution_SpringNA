...
for iii in range(1):
    ...
    ### Read in AMIP data
    amip = np.load(directorydata2 + 'ClimateIndices_ValidationSPEAR_%s_1979-2019.npz' % mon_index)
...
for iii in range(1):
    ### Read in AMIP data
    amip = np.load(directorydata2 + 'ClimateIndices_ValidationSPEAR-1880rf_%s_1979-2019.npz' % mon_index)
    indices = amip['indices']
    indicesvari = amip['indicesvari']
    yearsamip = amip['years']

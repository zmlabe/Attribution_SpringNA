...
datum = [decspear,decspearnoaer,decspearnatural]
...
plt.setp(axb,yticks=[y+1 for y in range(len(datum))],
                     yticklabels=['SPEAR_MED (30)','SPEAR_MED_NOAER (12)','SPEAR_MED_NATURAL (30)'])
...
plt.tight_layout()
plt.savefig(directoryfigure + 'TrendViolins_SPEAR_%s_%s-%s.png' % (sliceperiod,yrmin,yrmax),dpi=300)

"""
Calculate regression maps of Z30 onto T2M maps
...
pchZ30d = np.genfromtxt(directorydata2 + 'PCHZ30/PCHZ30_%s_%s_%s-%s_detrended.txt' % ('Z30',
                                                                                        monq,
                                                                                        1979,2019),
                                                                                        unpack=True)
...
slope,intercept,rvalue,pvalue,stderr = regressData(pchZ30,vardt,'obs')
...
plt.title(r'\textbf{%s-%s of Z30i(%s)-T2M(%s)}' % (yearmin,yearmax,monq,sliceperiod),fontsize=15,color='k')
...
plt.savefig(directoryfigure + 'RegressionMap_%s-%s_Z30i-%s_T2M-%s.png' % (yearmin,yearmax,monq,sliceperiod),dpi=300)

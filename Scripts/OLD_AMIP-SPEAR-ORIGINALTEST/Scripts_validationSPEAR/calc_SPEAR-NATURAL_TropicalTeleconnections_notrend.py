"""
Calculate tropical teleconnections for SPEAR-MED-NATURAL and do not detrend
...
directorydata = '/home/Zachary.Labe/Research/Attribution_SpringNA/Data/coupledSPEAR-NATURAL/'
...
for mn in range(len(monthsall)):
    ...
    ###############################################################################
    ### Save output 
    np.savez(directorydata + 'ClimateIndices-Tropical_coupledSPEAR_%s_1979-2019_trendIncluded.npz' % monq,

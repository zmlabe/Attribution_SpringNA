    ...
    for moo in range(len(monthsall)):
        ...
        for iii in range(len(variregress)):
            ...
            for mm in range(len(models)):
                ...
                plt.savefig(directoryfigure + 'RegressionCoupledSPEAR-NOAER_T2M_BoxNApattern_%s-%s_%s-%s_%s_globalsMaps.png' % (variq,mon_t2m,'T2M_BoxNA',mon_index,models[mm]),dpi=300)

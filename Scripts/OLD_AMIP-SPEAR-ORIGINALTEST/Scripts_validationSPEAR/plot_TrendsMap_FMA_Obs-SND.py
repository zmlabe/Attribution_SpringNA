...
barlim = np.round(np.arange(-0.05,0.06,0.05),2)

fig = plt.figure(figsize=(6,6))
label = r'\textbf{SND Trend [m/decade]}'
...
plt.savefig(directoryfigure + 'TrendsMap_%s_%s-%s_SND.png' % (sliceperiod,yearmin,yearmax),dpi=300)

"""
Calculate regression maps of AO onto T2M maps
...
slope,intercept,rvalue,pvalue,stderr = regressData(AO,vardt,'obs')
...
plt.title(r'\textbf{%s-%s of AOi(%s)-T2M(%s)}' % (yearmin,yearmax,monq,sliceperiod),fontsize=15,color='k')
...
plt.savefig(directoryfigure + 'RegressionMap_%s-%s_AOi-%s_T2M-%s.png' % (yearmin,yearmax,monq,sliceperiod),dpi=300)

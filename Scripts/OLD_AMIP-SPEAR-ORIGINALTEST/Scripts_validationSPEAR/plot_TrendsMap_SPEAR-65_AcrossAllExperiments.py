...
model_spear = ['spear']
experi1 = ['ERA5','SPEAR-LOW-65Lev','SPEAR-MED-AMIP','SPEAR-MED']
...
lath,lonh,spear = SP.read_SPEAR_LOW_Hindcast65lev(directorydata,variq,monthhind,slicenan,15)
...
plotdata = [trendobs,trendhind,spearamip,trendspearmean]
plotlat = [latobs,lath,lat,lat]
plotlon = [lonobs,lonh,lon,lon]
...
plt.savefig(directoryfigure + 'TrendsMap_%s_65lev_init-%s_%s_%s-%s_regridLOWS.png'% (slicemonth,monthhind,variq,yearmin,yearmax),dpi=300)

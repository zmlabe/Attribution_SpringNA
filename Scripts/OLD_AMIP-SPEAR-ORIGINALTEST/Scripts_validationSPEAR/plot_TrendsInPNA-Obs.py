...
directorydata = '/Users/zlabe/Documents/Research/Attribution_SpringNA/Data/Indices/ClimateIndices/PNA/' 

### Create months to loop through
monthsall = ['FMA']

years,meanz = np.genfromtxt(directorydata + 'PNAmodified_Z500_%s_1979-2019.txt' % monthsall[0],
                     unpack=True)
...
plt.ylabel(r'\textbf{Standardized}',fontsize=11,
                      color='dimgrey')
plt.title(r'\textbf{%s - PNA INDEX}' % monthsall[0],
                    color='k',fontsize=17)
plt.tight_layout()        

### Save figure
plt.savefig(directoryfigure+'%s_PNAindex_1979-2019.png' % monthsall[0],dpi=300)

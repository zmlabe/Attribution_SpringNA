"""
Calculate regression maps of Z100 onto T2M maps
...
pchZ100d = np.genfromtxt(directorydata2 + 'PCHZ100/PCHZ100_%s_%s_%s-%s_detrended.txt' % ('Z100',
                                                                                        monq,
                                                                                        yearmin,yearmax),
                                                                                        unpack=True)
...
slope,intercept,rvalue,pvalue,stderr = regressData(pchZ100,vardt,'obs')
...
plt.title(r'\textbf{%s-%s of Z100i(%s)-T2M(%s)}' % (yearmin,yearmax,monq,sliceperiod),fontsize=15,color='k')
...
plt.savefig(directoryfigure + 'RegressionMap_%s-%s_Z100i-%s_T2M-%s.png' % (yearmin,yearmax,monq,sliceperiod),dpi=300)

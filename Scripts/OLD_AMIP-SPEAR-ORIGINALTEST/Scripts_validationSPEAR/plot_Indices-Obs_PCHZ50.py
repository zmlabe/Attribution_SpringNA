"""
Plot monthly trends in the Arctic for the PCHZ50
...
pchZ50d = np.genfromtxt(directorydata + 'PCHZ50/PCHZ50_%s_%s_%s-%s_detrended.txt' % ('Z50',monq,
                                                                yearmin,yearmax),
                                                                unpack=True)
years_pchZ50 = pchZ50d[0,:]
pchZ50 = sts.zscore(pchZ50d[1,:])
    
### Calculate trends
slope_pchZ50,intercept_pchZ50,r_pchZ50,p_pchZ50,se_pchZ50 = sts.linregress(years,pchZ50)

### Calculate correlations
corr_pchZ50,pcorr_pchZ50 = sts.pearsonr(obsz,pchZ50)
...
rects = plt.bar(years,pchZ50,align='center',zorder=2,color='crimson',label=r'PCH-Z50',clip_on=False)
...
plt.savefig(directoryfigure + 'PCHZ50_Indices-Obs_%s' % monq,dpi=300)

...
directoryfigure = '/home/Zachary.Labe/Research/Attribution_SpringNA/Figures/ObsRegressions/T2M_BoxNA/' 
directorydata = '/work/Zachary.Labe/Data/' 
directorydata2 = '/work/Zachary.Labe/Data/ClimateIndices/'
directorydataoutput = '/home/Zachary.Labe/Research/Attribution_SpringNA/Data/RegressionPatternsObs/T2M_BoxNA/'
...
for mo in range(len(monthsall)):
    for moo in range(len(monthsall)):
        ...
        for iii in range(len(variregress)):
            ...
            NAOd = np.genfromtxt(directorydata2 + '%s/%s_%s_%s_%s-%s_detrended.txt' % ('T2M_BoxNA','T2M_BoxNA','T2M',monq,yearmin,yearmax),unpack=True)
            years_NAO = NAOd[1,:]

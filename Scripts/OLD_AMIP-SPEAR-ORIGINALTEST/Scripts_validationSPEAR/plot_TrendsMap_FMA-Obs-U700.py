"""
Plot trends in FMA from 1979 to 2019 for U700
...
### Read data
data = Dataset(directorydata + 'U700_1979-2021.nc')
lat1 = data.variables['latitude'][:]
lon1 = data.variables['longitude'][:]
snd = data.variables['U700'][:].reshape(years.shape[0],12,lat1.shape[0],lon1.shape[0])
data.close()
...
barlim = np.round(np.arange(-2,2.1,1),2)

fig = plt.figure(figsize=(6,6))
label = r'\textbf{U700 Trend [m/s/decade]}'
...
m = Basemap(projection='ortho',lon_0=270,lat_0=60,resolution='l',area_thresh=10000)
...
cs2 = m.contour(x,y,cl,np.arange(7,25,2),extend='both',

"""
Plot regression patterns for SPEAR-MED-NOAER over 1979 to 2019 for T2M_BoxNA
...
directoryfigure = '/home/Zachary.Labe/Research/Attribution_SpringNA/Figures/CoupledSPEAR/T2M_BoxNA/' 
directorydata = '/home/Zachary.Labe/Research/Attribution_SpringNA/Data/T2M_BoxNA_AllModels/' 
directoryoutput = '/home/Zachary.Labe/Research/Attribution_SpringNA/Data/RegressionPatternsCoupledSPEAR-NOAER/T2M_BoxNA/'

variregress = ['SNOW','Z500','SLP','SST','T2M','Z30','Z100','Z1000']
models = ['SPEAR-MED-NOAER']
level = 'surface'
    ...
    for moo in range(len(monthsall)):
        ...
        for iii in range(len(variregress)):
            ...
            for mm in range(len(models)):
                ...
                amip = np.load(directorydata + 'ClimateIndices_coupledSPEAR-NOAER-T2M_BoxNA_%s_1979-2019.npz' % mon_index)
                amipi = amip['spear'][0,:,:] # only one index in the file
        
                ### Read in AMIP data
                lat1q,lon1q,spear = SP.read_SPEAR_MED_NOAER('/work/Zachary.Labe/Data/SPEAR/SPEAR_MED_NOAER/monthly/',
                                                            variq,mon_t2m,4,'nan',12,'all')
                ...
                elif any([variq == 'Z30',variq == 'Z100',variq == 'Z1000',variq == 'Z500']):
                ...
                plt.savefig(directoryfigure + 'RegressionCoupledSPEAR-NOAER_T2M_BoxNApattern_%s-%s_%s-%s_%s.png' % (variq,mon_t2m,'T2M_BoxNA',mon_index,models[mm]),dpi=300)
                
                ### Save file
                np.savez(directoryoutput + 'RegressionCoupledSPEAR-NOAER_T2M_BoxNApattern_%s-%s_%s-%s_%s.npz' % (variq,mon_t2m,'T2M_BoxNA',mon_index,models[mm]),

"""
Plot time series of climate indices for amips-1880s_rf with ERA5
...
for i in range(len(indices)):
    ...
    for m in range(len(models)):
        ...
        amip = np.load(directoryoutput + 'ClimateIndices_ValidationSPEAR-1880rf_%s_1979-2019.npz' % monq)
        ...
        plt.savefig(directoryfigure + 'Index-1880srf-%s_Model-%s_%s.png' % (indicesdir[i],models[m],monq),dpi=300)

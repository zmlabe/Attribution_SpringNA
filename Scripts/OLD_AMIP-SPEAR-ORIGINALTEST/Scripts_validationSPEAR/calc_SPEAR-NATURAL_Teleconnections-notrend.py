"""
Calculate teleconnections for SPEAR-MED-NATURAL and do not detrend
...
for mn in range(len(monthsall)):
    ...
    ###############################################################################
    ### Save output 
    np.savez(directorydata + 'ClimateIndices_coupledSPEAR-NATURAL_%s_1979-2019_trendIncluded.npz' % monq,

...
model_spear = ['spear']
experi1 = ['ERA5','SPEAR-LOW-33Lev','SPEAR-MED-AMIP','SPEAR-MED']
...
lath,lonh,spear = SP.read_SPEAR_LOW_Hindcast33lev(directorydata,variq,monthhind,slicenan,15)
...
plt.savefig(directoryfigure + 'TrendsMap_%s_33lev_init-%s_%s_%s-%s.png'% (slicemonth,monthhind,variq,yearmin,yearmax),dpi=300)
